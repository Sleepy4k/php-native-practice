<?php
  ...
  $css_path = get_base_url() . "/public/css/auth.css";
  $register_controller = get_base_url() . "/controller/handle_register.php";
  $login_view = get_base_url() . "/view/login.php";
?>
...
<html lang="en">
  <head>
    ...
    <title>PHP Native Practice | Register</title>
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    <main class="form-signin w-100 m-auto">
      <form class="form-signin" action="<?php echo $register_controller ?>" method="post">
        ...
        <a class="btn btn-primary w-100 py-2" href="<?php echo $login_view ?>">Already have account? Sign in</a>
